 ...
 * @since 0.1
 */
public class CombinedAndPredicate implements Func<DbObject<?>, Boolean> {
     ...
     */
    public CombinedAndPredicate(final Iterable<Func<DbObject<?>, Boolean>> funcs) {
        this.funcs = funcs;
    }
     ...
     */
    @SafeVarargs
    public CombinedAndPredicate(final Func<DbObject<?>, Boolean>... funcs) {
