...
/**
 * The type of {@link DbdViewMapping} that can be constructed
 *  of all {@link Objects} and current {@link DbObject}.
 * @since 0.1
 */
public class DbdViewMappingOfObjects extends DbdViewMapping {
