...
public class SimpleDBD implements DBD {
    ...
    public SimpleDBD(final Iterable<Server> serverDBDs, final Iterable<Schema> schemaDBDs) {
        this.serverDBDs = serverDBDs;
        this.schemaDBDs = schemaDBDs;
    }

    @Override
    public final Iterable<Server> serverDescriptions() {
        return this.serverDBDs;
    }

    @Override
    public final Iterable<Schema> schemaDescriptions() {
