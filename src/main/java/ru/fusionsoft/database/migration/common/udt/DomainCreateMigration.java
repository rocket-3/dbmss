...
import ru.fusionsoft.database.migration.postgres.PgDomainCreateSql;
...
/**
 * The Migration to create domain of domain {@link DbObject} and DBMS specified.
 * @since 0.1
 */
public class DomainCreateMigration implements Migration {
    ...
    /**
     * Instantiates a new Domain create migration.
     * @param object The {@link DbObject} to be encapsulated.
     * @param dbms The {@link Dbms} to be encapsulated.
     */
    public DomainCreateMigration(final DbObject<DbdDomainMapping> object, final Dbms dbms) {
        this.object = object;
        this.dbms = dbms;
    }
    ...
    public final Text sql() {
        return new TextOfDbmsConditional(
            new PgDomainCreateSql(this.object),
            () -> "",
            () -> "",
            () -> "",
            this.dbms
