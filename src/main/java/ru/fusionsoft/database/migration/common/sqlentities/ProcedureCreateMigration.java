...
import ru.fusionsoft.database.migration.postgres.PgProcedureCreateSql;
...
/**
 * The Migration to create procedure of procedure {@link DbObject} and DBMS specified.
 * @since 0.1
 */
public class ProcedureCreateMigration implements Migration {
    ...
    public final Text sql() {
        return new TextOfDbmsConditional(
            new PgProcedureCreateSql(this.object),
            () -> "",
            () -> "",
            () -> "",
            this.dbms
