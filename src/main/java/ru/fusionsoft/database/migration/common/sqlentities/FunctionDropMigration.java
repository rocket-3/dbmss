...
import ru.fusionsoft.database.migration.postgres.PgFunctionDropSql;
...
/**
 * The Migration to drop function of function {@link DbObject} and DBMS specified.
 * @since 0.1
 */
public class FunctionDropMigration implements Migration {
    ...
    public final Text sql() {
        return new TextOfDbmsConditional(
            new PgFunctionDropSql(this.object),
            () -> "",
            () -> "",
            () -> "",
            this.dbms
