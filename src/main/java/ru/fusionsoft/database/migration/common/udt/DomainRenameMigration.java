...
/**
 * The Migration to rename domain of domain {@link DbObject} and DBMS specified
 *  to {@link SwappingEntityNameSuffix}-version.
 * @since 0.1
 */
public class DomainRenameMigration implements Migration {
     ...
     */
    public DomainRenameMigration(final DbObject<DbdDomainMapping> object, final Dbms dbms) {
        this.object = object;
        this.dbms = dbms;
    }
