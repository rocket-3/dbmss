...
import ru.fusionsoft.database.migration.postgres.PgTriggerDropSql;
...
/**
 * The Migration to drop trigger of trigger {@link DbObject} and DBMS specified.
 * @since 0.1
 */
public class TriggerDropMigration implements Migration {
    ...
    public final Text sql() {
        return new TextOfDbmsConditional(
            new PgTriggerDropSql(this.object),
            () -> "",
            () -> "",
            () -> "",
            this.dbms
