...
/**
 * The Migration to rename tuple UDT of tuple {@link DbObject} and DBMS specified
 *  to {@link SwappingEntityNameSuffix}-version.
 * @since 0.1
 */
public class TupleRenameMigration implements Migration {
     ...
     */
    public TupleRenameMigration(final DbObject<DbdDomainMapping> object, final Dbms dbms) {
        this.object = object;
        this.dbms = dbms;
    }
