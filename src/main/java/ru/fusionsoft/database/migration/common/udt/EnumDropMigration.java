...
import ru.fusionsoft.database.migration.postgres.PgEnumDropSql;
...
/**
 * The Migration to drop enum UDT of enum {@link DbObject} and DBMS specified.
 * @since 0.1
 */
public class EnumDropMigration implements Migration {
    ...
    /**
     * Instantiates a new Enum drop migration.
     * @param object The {@link DbObject} to be encapsulated.
     * @param dbms The {@link Dbms} to be encapsulated.
     */
    public EnumDropMigration(final DbObject<DbdEnumMapping> object, final Dbms dbms) {
        this.object = object;
        this.dbms = dbms;
    }
