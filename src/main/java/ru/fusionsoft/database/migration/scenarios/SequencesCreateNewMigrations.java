...
import ru.fusionsoft.database.migration.common.SequenceCreateMigration;
...
/**
 * Migrations to create sequences, that are in next database state.
 * @since 0.1
 */
public class SequencesCreateNewMigrations extends IterableOfScalarSticky<Migration> {

    /**
     * Instantiates a new Sequences create new migrations.
     ...
     */
    public SequencesCreateNewMigrations(
    ...
    public SequencesCreateNewMigrations(
        ...
        super(
            () -> {
                return new Mapped<>(
                    obj -> new SequenceCreateMigration(obj, dbms),
