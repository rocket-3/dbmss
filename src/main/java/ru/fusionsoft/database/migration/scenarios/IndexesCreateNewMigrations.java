...
/**
 * Migrations to create new indexes, that are in new database state only.
 * @since 0.1
 * @checkstyle ClassDataAbstractionCouplingCheck (100 lines)
 */
public class IndexesCreateNewMigrations extends IterableOfScalarSticky<Migration> {
     ...
     */
    public IndexesCreateNewMigrations(
