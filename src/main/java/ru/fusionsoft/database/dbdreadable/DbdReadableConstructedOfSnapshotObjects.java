...
/**
 * The {@link DbdReadable} can be constructed of
 *  'server', 'info' and objects descriptions.
 * @since 0.1
 */
public class DbdReadableConstructedOfSnapshotObjects extends DbdReadableOfRootMapping {
     ...
     */
    public <Y extends YamlNode> DbdReadableConstructedOfSnapshotObjects(
