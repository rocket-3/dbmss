...
/**
 * The type of {@link DbdReadable} that can be constructed of {@link YamlMapping}
 *  and returns specific {@link DbdRootMapping}.
 * @since 0.1
 */
public class DbdReadableOfMapping extends DbdReadableOfRootMapping {

    /**
     * Instantiates a new Dbd file of mapping.
     * @param mapping The YamlMapping to be encapsulated.
     */
    public DbdReadableOfMapping(final YamlMapping mapping) {
