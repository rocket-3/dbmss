...
public class DeletedObjectsOfDiff<Y extends YamlNode> extends IterableOfScalarSticky<DbObject<Y>> {


    public DeletedObjectsOfDiff(final TemporalDiff<Iterable<DbObject<Y>>> objects) {
        super(
