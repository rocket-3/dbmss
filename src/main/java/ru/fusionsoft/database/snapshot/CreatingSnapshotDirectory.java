...
public class CreatingSnapshotDirectory implements Directory {
     ...
     */
    private CreatingSnapshotDirectory(final Scalar<Path> dbgit, final Text name) {
        this.root = dbgit;
        this.name = name;
    }
     ...
     */
    public CreatingSnapshotDirectory(final Utc time) {
        this(
