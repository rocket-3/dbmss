...
public class ObjectOfDbdFunctionMapping extends SimpleDbObject<DbdFunctionMapping> {
     ...
     */
    public ObjectOfDbdFunctionMapping(
        final YamlMapping functions,
        final YamlNode key,
        final ObjectName schema
    ) {
        this(
            new DbdFunctionMapping(new YamlMappingOfPath(functions, key)),
     ...
     * @param yaml The {@link DbdFunctionMapping} to be encapsulated.
     * @param name The {@link ObjectName} to be encapsulated.
     */
    public ObjectOfDbdFunctionMapping(final DbdFunctionMapping yaml, final ObjectName name) {
        super(
            yaml,
