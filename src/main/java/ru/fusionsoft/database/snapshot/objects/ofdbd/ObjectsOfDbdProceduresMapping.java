...
public class ObjectsOfDbdProceduresMapping extends IterableEnvelope<DbObject<DbdProcedureMapping>> {
    ...
    /**
     * Instantiates a new Objects of procedures.
     * @param procedures The YamlMapping to be encapsulated.
     * @param schema The Text to be encapsulated.
     */
    public ObjectsOfDbdProceduresMapping(final YamlMapping procedures, final ObjectName schema) {
        super(
            new IterableOfClassFromYamlNode<>(
                (parent, key) -> new ObjectOfDbdProcedureMapping(parent, key, schema),
                procedures
            )
        );
    }
