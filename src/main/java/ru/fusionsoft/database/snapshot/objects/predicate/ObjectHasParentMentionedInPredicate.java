 ...
 */
public class ObjectHasParentMentionedInPredicate implements Func<DbObject<?>, Boolean> {
     ...
     */
    private ObjectHasParentMentionedInPredicate(
     ...
     */
    public ObjectHasParentMentionedInPredicate(final Objects<?> mentions) {
