...
import ru.fusionsoft.database.snapshot.objects.ofresultset.IndexOfResultSet;
import ru.fusionsoft.database.snapshot.query.pg.PgIndexesQuery;
 ...
 * @since 0.1
 */
public class PgIndexes extends ObjectsOfScalar<DbdIndexMapping> {
