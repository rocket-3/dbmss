 ...
 * @since 0.1
 */
public class DbdDocumentOfServerSnapshotDefault extends DbdDocument {
     ...
     */
    public DbdDocumentOfServerSnapshotDefault(
        final DbdServerMapping server,
        final Utc time,
        final Objects<?> objects
    ) {
        super(
            new DbdFileOfServerSnapshotDefault(server, time, objects)
        );
    }
