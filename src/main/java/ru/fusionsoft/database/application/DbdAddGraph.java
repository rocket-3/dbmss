...
import ru.fusionsoft.database.api.DbdAddObjectsGraphProcedure;
 ...
 *  then filters them by type and name regexes, also taking all the dependencies of checked
 *  objects, the objects that depends on previous, and the dependencies of the whole set again,
 *  then merges them in DBD.
 * @since 0.1
 * @checkstyle HideUtilityClassConstructorCheck (100 lines)
 */
@SuppressWarnings("PMD")
public final class DbdAddGraph {

    /**
     * Main.
     * @param args The array of {@link String} args,
     *  which are:  {server name} {type rgx} {name rgx}.
    ...
    public static void main(final String[] args) throws Exception {
        ...
        new Ternary<Runnable>(
            ...
            () -> new DbdAddObjectsGraphProcedure(
                new TextOf(args[0]),
                new TextOf(args[1]),
                new TextOf(args[2]),
