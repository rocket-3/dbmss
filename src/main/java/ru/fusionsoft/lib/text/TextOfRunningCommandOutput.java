...
import ru.fusionsoft.lib.runnable.process.ProcessExitRedirectErrors;

/**
 * The text of running command output, supports setting working directory and stdin lines.
 * @since 0.1
 */
public class TextOfRunningCommandOutput implements Text {
    ...
    /**
     * Instantiates a new Text of running command output.
     * @param origin The working directory to be encapsulated.
     * @param command The command args to be encapsulated.
     * @param input The command input to be encapsulated.
     */
    public TextOfRunningCommandOutput(
    ...
    public TextOfRunningCommandOutput(
        ...
        this(origin, command, new IterableOf<String>());
    }
