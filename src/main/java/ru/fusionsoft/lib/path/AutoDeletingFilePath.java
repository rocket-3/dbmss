 ...
 */
public class AutoDeletingFilePath implements Scalar<Path>, AutoCloseable {
     ...
     */
    public AutoDeletingFilePath(final Scalar<Path> origin) {
     ...
     */
    public AutoDeletingFilePath(final Path origin) {
        this(() -> origin);
    }
